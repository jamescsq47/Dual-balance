...
# lut = torch.load("cogvideo_lut.pt").cuda()
# print(lut)
...
# torch.save(mask, "cogvideo_mask.pt")

# sparse = torch.load("cogvideo_mask.pt").cuda()
# sparse = torch.repeat_interleave(sparse, 2, dim=2)
# torch.save(sparse, "cogvideo_mask.pt")
sparse = torch.load("cogvideo_mask.pt").cuda()
print(sparse.shape)
...
# plt.tight_layout()
# plt.savefig(f'cogvideo_{block}.png')
