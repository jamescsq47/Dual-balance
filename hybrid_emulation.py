...
# plt.tight_layout()
# plt.savefig(f'sparse_0.414_block{block}_ulysses{ulysses_degree}_ring_{ring_degree}.png')
...
# plt.tight_layout()
# plt.savefig(f'sparse_final_block{block}_ulysses{ulysses_degree}_ring_{ring_degree}.png')
