...
sparse = torch.load("/root/chensiqi/cogvideo_head_density_all.pt")
sparse_new = torch.load("/root/chensiqi/cogvideo_head_density_perm.pt")
sparse_new2 = torch.load("/root/chensiqi/cogvideo_head_density_perm2.pt")
perm_idx_all = torch.load("/root/chensiqi/cogvideo_perm_idx_all.pt")
deperm_idx_all = torch.load("/root/chensiqi/cogvideo_deperm_idx_all.pt")
print(sparse[1][0])
