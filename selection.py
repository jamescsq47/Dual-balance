...
list1 = torch.load("total_time_list_u8r1.pt")
list2 = torch.load("total_time_list_u4r2.pt")
list3 = torch.load("total_time_list_u2r4.pt")
list4 = torch.load("total_time_list_u1r8.pt")
