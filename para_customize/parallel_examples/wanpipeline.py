    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                #     if imbalance_ratio(head_density,num_groups=8) > 1:
                ...
                if head_density is not None:
                    ...
                    imbalance_ratio_list.append(imbalance_ratio(head_density,num_groups=8).item())
        ...
        print("average imbalance ratio:", sum(imbalance_ratio_list)/len(imbalance_ratio_list))
    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                time += total_time
                if dist.get_rank() == 0:
                    print(f"timestep:{i}, total attention time: {total_time} ms")
        ...
        # torch.save(total_time_list, "/root/chensiqi/Dual-balance/total_time_list_u8r1.pt")
        # plt.figure()
        # plt.plot(total_time_list, marker='o')
        # plt.xlabel('Timestep')
        # plt.ylabel('Total Attention Time (ms)')
