...
# 加载两个 list
list2 = torch.load('total_time_list_2.pt')
list4 = torch.load('total_time_list_4.pt')
list8 = torch.load('total_time_list_8.pt')
list8_original = torch.load('total_time_list_8_original.pt')
...
plt.grid(True)
plt.legend()
plt.savefig('timestep_compare_normalize.png')
plt.close()
...
plt.grid(True)
plt.legend()
plt.savefig('timestep_compare.png')
plt.close()
...
plt.grid(True)
plt.legend()
plt.savefig('timestep_compare2.png')
plt.close()
