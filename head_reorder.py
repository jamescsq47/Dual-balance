...
data2 = torch.load("sparse_plan_expanded.pth", map_location='cpu', weights_only=True)
...
torch.save(perm_idx_list, "perm_idx_all.pt")
torch.save(deperm_idx_list, "deperm_idx_all.pt")
torch.save(sparse_reordered_all, "sparse_reordered_all.pt")
